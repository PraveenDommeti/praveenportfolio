        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center space-y-6 animate-slideIn3d">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-[fadeIn_1s_ease-out_1.2s_both]">
              Passionate about creating innovative web solutions and extracting
              meaningful insights from data. I combine modern development
              practices with data-driven approaches to build impactful digital
              experiences.
            </p>
            ...
            <div className="flex justify-center space-x-6 pt-8 animate-[fadeIn_1s_ease-out_1.6s_both]">
              <a
                href="mailto:praveendommeti06@gmail.com"
                className="text-muted-foreground hover:text-primary transition-colors"
              >
                <Mail className="w-6 h-6" />
              </a>
              <a
                href="https://www.linkedin.com/in/praveen-dommeti-06ba41279/"
                target="_blank"
              ...
              <a
                href="https://github.com/PraveenDommeti"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
              >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-slide-in-left">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                I am a passionate software engineer with expertise in modern web
                technologies and a commitment to delivering exceptional digital
                solutions. Currently pursuing my Bachelor's in Information
                Technology with a strong CGPA of 9.09.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                My journey in technology spans across full-stack development,
                database management, and data visualization. I believe in
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <CardDescription className="text-lg">
                    Technosprint Info Solutions - Chennai, India
                  </CardDescription>
                </div>
            ...
            <CardContent className="space-y-4">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start">
                  ...
                  Contributed to the development of several frontend web
                  applications, leveraging modern frameworks and libraries to
                  create user interfaces.
                </li>
                <li className="flex items-start">
                  <ChevronRight className="w-4 h-4 mr-2 mt-0.5 text-primary flex-shrink-0" />
                  Worked extensively on data management and database operations,
                  ensuring seamless integration between frontend and backend
                  systems.
                </li>
                <li className="flex items-start">
                  <ChevronRight className="w-4 h-4 mr-2 mt-0.5 text-primary flex-shrink-0" />
                  Participated in all phases of a full-stack project,
                  contributing to both client-facing and server-side
                  development, and ensuring seamless integration.
                </li>
                <li className="flex items-start">
                  <ChevronRight className="w-4 h-4 mr-2 mt-0.5 text-primary flex-shrink-0" />
                  Led a key project initiative, moving from conception to
                  deployment lifecycle and guiding a small team to meet project
                  milestones.
                </li>
              </ul>
            </CardContent>
      ...
      <section id="projects" className="py-16 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="group hover:shadow-2xl transition-all duration-700 hover:scale-105 hover:-rotate-2 transform-gpu perspective-1000">
              <CardHeader>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Designed and implemented a relational database for IPL match
                  statistics. Demonstrated strong understanding of relational
            ...
            <Card className="group hover:shadow-2xl transition-all duration-700 hover:scale-105 hover:-rotate-2 transform-gpu perspective-1000">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Developed a fashion-based social commerce app from scratch
                  where users post daily outfits, tag products, earn streak
                  points, and monetize through in-app product referrals.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://lovable.dev/projects/4eede3be-2b11-4338-9cae-32b31e53ae58",
                      "_blank",
                    )
                  }
                >
            ...
            <Card className="group hover:shadow-2xl transition-all duration-700 hover:scale-105 hover:-rotate-2 transform-gpu perspective-1000">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Visualized real-world datasets using Matplotlib to create bar
                  graphs, pie charts, and line plots. Gained experience in
                  Python libraries for data interpretation.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <Badge variant="secondary">Python</Badge>
                  <Badge variant="secondary">Matplotlib</Badge>
      ...
      <section id="languages" className="py-16 px-6 bg-background">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Languages I am proficient in for professional, academic, and daily
              communication
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Conversational | Regional Communication
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center justify-between">
      ...
      <section id="certifications" className="py-16 px-6 bg-card">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Professional and academic certifications earned
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Demonstrated proficiency in SQL queries, data analysis, and
                  database management concepts.
                </p>
                <Button variant="outline" size="sm" asChild>
                  <a
                    href="/lovable-uploads/SQl.png"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View Certificate
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Completed training in Python programming, covering core
                  concepts, syntax, and practical applications.
                </p>
                <Button variant="outline" size="sm" asChild>
                  <a
                    href="/lovable-uploads/python certificate(infosys).pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View Certificate
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Learned data science concepts and techniques using Python,
                  including data manipulation and visualization.
                </p>
                <Button variant="outline" size="sm" asChild>
                  <a
                    href="/lovable-uploads/nptel certificate.jpg"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View Certificate
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription className="text-lg">
                      ...
                      India
                      <br />
                      Honours degree in Advanced Web Development
                    </CardDescription>
                  </div>
